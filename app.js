    ...
    <div class="card">
      <div class="card-body">
        ...
        <div class="actions">
          ...
          <button class="btn-ghost" onclick="openInfo('${m.info}')">ℹ️ Info</button>
...
function openInfo(pdfUrl) {
  // Create a full-page container for the PDF
  ...
  viewerContainer.innerHTML = `
    ...
    <iframe src="${pdfUrl}" width="100%" height="95%" style="border:none;"></iframe>
  `;
